...
namespace ShapeDatabase.Features.Descriptors {
	...
	public sealed class FeatureManager {
		...
		/// <summary>
		/// A collection of all the saved featurevectors in this manager.
		/// </summary>
		public IEnumerable<FeatureVector> FeatureVectors => features.Values;

		/// <summary>
		/// The total amount of featurevectors stored in this manager.
		/// </summary>
		...
		/// <summary>
		/// Updates the min and max values and normalises all featurevectors.
		/// </summary>
		...
		/// </summary>
		/// <param name="left">The collection of descriptors which might be returned.</param>
		...
		/// <summary>
		/// Compares the given mesh with all the saved meshes in this <see cref="FeatureManager"/>
